...
export default function BlockCard({ title, description, image }: StepProps) {
  return (
    <div className='bg-gray flex max-w-2xs flex-col items-center gap-3 rounded-xl p-6 transition-all duration-300 hover:scale-[1.02] max-lg:px-5 max-lg:py-5 max-sm:max-w-[340px] max-sm:flex-row max-sm:gap-4 max-sm:p-4 max-sm:text-left'>
