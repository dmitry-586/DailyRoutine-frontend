...
export function HabitModal({ open, onClose, onSave, habit }: HabitModalProps) {
	...
	return (
		<Dialog open={open} onOpenChange={onClose}>
			<DialogContent className='bg-gradient-to-br from-[#3D4348] to-[#32373A] border-[#B3B3B3]/20 text-white max-w-lg max-h-[90vh] overflow-y-auto'>
				<DialogHeader>
				...
				<div className='space-y-6 py-4'>
					...
					<div className='space-y-2'>
						...
						<Input
							...
							className='bg-[#32373A] border-[#B3B3B3]/20 text-white'
						/>
					</div>
					...
					<div className='space-y-3'>
						...
						>
							<div className='flex items-center space-x-2 p-4 rounded-xl border-2 transition-all duration-200 hover:border-[#4CAF50]/50 hover:bg-[#32373A]/80 bg-gradient-to-br from-[#32373A] to-[#2D3134] cursor-pointer group'>
								<RadioGroupItem
									value='good'
									id='good'
									className='group-hover:border-[#4CAF50] transition-all duration-200'
								/>
								<Label htmlFor='good' className='flex-1 cursor-pointer'>
									<div className='flex items-center gap-3'>
										<div className='w-4 h-4 rounded-full bg-[#4CAF50] shadow-lg shadow-[#4CAF50]/30 group-hover:shadow-[#4CAF50]/50 transition-all duration-200' />
										<span className='font-semibold'>Полезная привычка</span>
									</div>
									<p className='text-sm text-[#B3B3B3] mt-1.5 ml-7 group-hover:text-[#B3B3B3]/80 transition-colors duration-200'>
										Отмечайте выполнение каждый день
									</p>
								</Label>
							</div>
							<div className='flex items-center space-x-2 p-4 rounded-xl border-2 transition-all duration-200 hover:border-[#F44336]/50 hover:bg-[#32373A]/80 bg-gradient-to-br from-[#32373A] to-[#2D3134] cursor-pointer group'>
								<RadioGroupItem
									value='bad'
									id='bad'
									className='group-hover:border-[#F44336] transition-all duration-200'
								/>
								<Label htmlFor='bad' className='flex-1 cursor-pointer'>
									<div className='flex items-center gap-3'>
										<div className='w-4 h-4 rounded-full bg-[#F44336] shadow-lg shadow-[#F44336]/30 group-hover:shadow-[#F44336]/50 transition-all duration-200' />
					...
					<div className='space-y-3'>
						...
						>
							<div className='flex items-center space-x-2 p-4 rounded-xl border-2 transition-all duration-200 hover:border-[#1CBECB]/50 hover:bg-[#32373A]/80 bg-gradient-to-br from-[#32373A] to-[#2D3134] cursor-pointer group'>
								<RadioGroupItem
									value='binary'
									id='binary'
									className='group-hover:border-[#1CBECB] transition-all duration-200'
								/>
								<Label htmlFor='binary' className='flex-1 cursor-pointer'>
									<span className='font-semibold'>Да / Нет</span>
									<p className='text-sm text-[#B3B3B3] mt-1.5 group-hover:text-[#B3B3B3]/80 transition-colors duration-200'>
						...
						<div className='space-y-2'>
							...
							<div className='flex gap-2'>
								...
								<Select value={unit} onValueChange={setUnit}>
									<SelectTrigger className='w-[140px] bg-[#32373A] border-[#B3B3B3]/20 text-white'>
										<SelectValue />
									</SelectTrigger>
									<SelectContent className='bg-[#3D4348] border-[#B3B3B3]/20 text-white'>
										{habitFormat === 'time' ? (
											<>
				...
				<div className='flex gap-3 justify-end pt-2'>
					<Button
						variant='outline'
						onClick={onClose}
						className='border-[#B3B3B3]/20 hover:bg-[#32373A] hover:border-[#B3B3B3]/30 transition-all duration-200'
					>
						Отмена
					</Button>
					<Button
						...
						className='bg-gradient-to-r from-[#1CBECB] to-[#17a2b3] hover:from-[#17a2b3] hover:to-[#1CBECB] shadow-lg shadow-[#1CBECB]/20 hover:shadow-xl hover:shadow-[#1CBECB]/30 hover:scale-105 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100'
					>
