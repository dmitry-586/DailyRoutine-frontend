		...
		<div className='min-h-screen bg-[#2D3134] p-4 sm:p-6'>
			<div className='max-w-7xl mx-auto'>
				...
				<div className='mb-6 sm:mb-8'>
					<h1 className='text-white mb-2'>Магазин</h1>
				...
				{/* Balance Card */}
				<Card className='bg-gradient-to-r from-[#1CBECB] to-[#4CAF50] border-none p-6 mb-8'>
					<div className='flex items-center justify-between'>
						<div>
							<p className='text-white/80 mb-1'>Ваш баланс</p>
							<div className='flex items-center gap-2'>
								<Award className='w-8 h-8 text-white' />
								<span className='text-white text-4xl'>{balance}</span>
								<span className='text-white/80 text-xl'>дейликов</span>
							</div>
						</div>
						<div className='text-right'>
							<p className='text-white/80 text-sm'>Заработано за неделю</p>
							<p className='text-white text-2xl'>+85</p>
						</div>
					</div>
				</Card>
				...
				<div className='mb-6 space-y-4'>
					<div className='flex items-center gap-4 flex-wrap'>
						...
						>
							<SelectTrigger className='w-[140px] bg-[#3D4348] border-[#B3B3B3]/20 text-white'>
						...
						>
							<SelectTrigger className='w-[160px] bg-[#3D4348] border-[#B3B3B3]/20 text-white'>
						...
						{hasActiveFilters && (
							<Button
								...
								className='border-[#B3B3B3]/20 text-[#B3B3B3] hover:text-white hover:border-[#B3B3B3]/30 transition-all duration-200'
							>
				...
				{filteredItems.length === 0 ? (
					<div className='bg-[#3D4348] rounded-xl p-12 text-center'>
						<p className='text-[#B3B3B3] mb-4'>Товары не найдены</p>
						{hasActiveFilters && (
							<Button
								variant='outline'
								onClick={clearFilters}
					...
					<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4'>
						{filteredItems.map(item => (
							<Card
								key={item.id}
								className='bg-[#3D4348] border-none p-6 flex flex-col hover:border hover:border-[#1CBECB]/30 hover:shadow-lg hover:shadow-[#1CBECB]/10 transition-all duration-200 hover:scale-[1.02]'
							>
								<div className='text-center mb-4'>
									<div className='text-6xl mb-3'>{item.preview}</div>
								...
								<div className='mt-auto'>
									<div className='flex items-center justify-center gap-2 mb-3'>
										<Award className='w-5 h-5 text-[#1CBECB]' />
										...
										<Button
											className={`w-full transition-all duration-200 ${
												canAfford(item.price)
													? 'bg-[#1CBECB] hover:bg-[#1CBECB]/90 hover:shadow-md hover:shadow-[#1CBECB]/20 hover:scale-105'
													: 'bg-[#32373A] text-[#B3B3B3] cursor-not-allowed'
											}`}
				...
				{/* Tips Section */}
				<Card className='bg-[#3D4348] border-none p-6 mt-8'>
					<h3 className='text-white mb-4'>Как заработать дейлики?</h3>
					<div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
						<div className='flex items-start gap-3'>
							...
							<div>
								<p className='text-white mb-1'>Выполняйте привычки</p>
						...
						<div className='flex items-start gap-3'>
							...
							<div>
								<p className='text-white mb-1'>Поддерживайте серии</p>
								<p className='text-[#B3B3B3] text-sm'>
						...
						<div className='flex items-start gap-3'>
							...
							<div>
								<p className='text-white mb-1'>Завершайте спринты</p>
								<p className='text-[#B3B3B3] text-sm'>
